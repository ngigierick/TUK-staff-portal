...
abstract class BaseStudent extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('reg_number, college_number, class_code, academicyear_id, semester_id, title_id, id_number, surname, module_id, firstname, programme_id,  gender_id, marital_status_id, nationality_id, county_id, religion_id, mobile, email, disability_id, status', 'required'),
