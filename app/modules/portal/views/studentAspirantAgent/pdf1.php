...
<div class="wrapper">
	...
	<h2>FORM 1B: TO BE COMPLETED BY RUNNING MATE </h2>
	<table class="table preview bordered" width="100%"><tr>
		...
		<td >
			...
			<?php 
				...
				echo CHtml::image($photo,'Passport photo not yet submitted',array('height'=>100,'class'=>'passport')); 
	...
	<tr>
		<td valign="top" colspan="2">
			<br/><br/>
			<center>
			I AM A RUNNING MATE FOR <b><?php echo ($aspirant->gender_id==1)?' MR ':' MISS '; echo strtoupper($aspirant->surname.' '.$aspirant->firstname.' '.$aspirant->othername);?></b> 
	...
	<tr>
		<td colspan="2">
			...
			<ul>
				...
				<li>I  have  cleared my school fees for this semester.</li>
			</ul>
			</ul>
		</td>
	</tr>
...
<h3 class="page">Page 1B of 12</h3>
</div>
