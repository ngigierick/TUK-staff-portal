...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<fieldset>
		<?php if ($model->running_mate==1):?>
		<legend>PART II - RUNNING MATE DETAILS -<?php echo $model->surname.' '.$model->firstname.' '.$model->othername;?> </legend>
		<?php else:?>
			<legend>PART II - AGENT DETAILS -<?php echo $model->surname.' '.$model->firstname.' '.$model->othername;?> </legend>
		<?php endif;?>
...
<div class="form-actions">
	<?php $this->widget('bootstrap.widgets.TbButton', array(
		...
		'type'=>'success',
		'icon'=>'ok',
		'label'=>'I ACCEPT THIS REQUEST TO PRINT THE FORM AND SUBMIT WITH THESE DETAILS',
	)); ?><hr /><br />
	<?php $this->widget('bootstrap.widgets.TbButton', array(
			'label'=>'I DECLINE THIS REQUEST',
			'type'=>'danger', 
			'size'=>'medium', 
			'icon'=>'list',
			'url'=>array('decline','id'=>$model->id),
		)); ?>
