<h2><span class="icon-thumbs-up"> </span> This is how the public views your profile!</h2>
<?php $this->renderPartial('employee/pdf_header', array('model'=>$model,'st'=>1));?>
...
<hr />
<?php echo	CHtml::link('<span class="icon-download-alt"> </span> Download Profile', Yii::app()->createUrl('//portal/profile/public',array('id'=>$model->id,'pdf'=>1)));?>
