...
<h1><?php echo Yii::t('app', 'View') . '  ' . GxHtml::encode($model->label()) . ' performed on ' . GxHtml::encode($model->date_added); ?></h1>
...
<h2><?php echo GxHtml::link('View Project Phase for this Activity',array('//help/projectPhase/view','id'=>$model->phase_id));?></h2>
