...
<?php $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
	...
	<?php echo $form->dropDownList($model, 'assigned_id', GxHtml::listDataEx(User::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	...
	<?php echo $form->dropDownList($model, 'module_id', GxHtml::listDataEx(ProjectModule::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
