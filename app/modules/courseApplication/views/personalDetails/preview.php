...
.home{
	font:98.25%/1.231  'Arial',tahoma,verdana,arial,sans-serif;
	font-size:13px;
	line-height:1.2;
	text-transform:uppercase;
	margin-bottom:10px;
...
<tr><td style="text-align:right"><b>Course Applied for:</b> </td><td><?php echo $courses[$i]->programme;?></td></tr>
<tr><td style="text-align:right"><b>Course Code:</b> </td><td><?php echo $courses[$i]->programme_id;?></td></tr>
...
<hr />
<table class="table preview" width="100%">
<tr><td colspan="2">I hereby declare that the above information is complete and accurate to the best of my knowledge.<br />
Sign:...................................................... Date:.....................................................
 </td>
 </tr>
</table>
...
<?php echo CHtml::hiddenField('pdf',1);?>
<hr />
<?php $this->widget('bootstrap.widgets.TbButton', array(
    'buttonType'=>'submit',
	'label'=>'Generate PDF and Print',
    'type'=>'danger', 
    'size'=>'large', 
	'icon'=>'print',
	'url'=>array('preview'),
