...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'college_number'); ?>
		<?php echo $form->textField($model, 'college_number', array('maxlength' => 30)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'district_id', GxHtml::listDataEx(District::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model, 'c_postal_address'); ?>
		<?php echo $form->textField($model, 'c_postal_address', array('maxlength' => 200)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'c_postcode'); ?>
		<?php echo $form->textField($model, 'c_postcode', array('maxlength' => 10)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'c_town'); ?>
		<?php echo $form->textField($model, 'c_town', array('maxlength' => 20)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'c_mobile'); ?>
		<?php echo $form->textField($model, 'c_mobile', array('maxlength' => 20)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'c_email'); ?>
		<?php echo $form->textField($model, 'c_email', array('maxlength' => 30)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'nok_surname'); ?>
		<?php echo $form->textField($model, 'nok_surname', array('maxlength' => 30)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'nok_firstname'); ?>
		<?php echo $form->textField($model, 'nok_firstname', array('maxlength' => 30)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'nok_othername'); ?>
		<?php echo $form->textField($model, 'nok_othername', array('maxlength' => 30)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'nok_title_id'); ?>
		<?php echo $form->dropDownList($model, 'nok_title_id', GxHtml::listDataEx(Title::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'nok_relation_id'); ?>
		<?php echo $form->dropDownList($model, 'nok_relation_id', GxHtml::listDataEx(Relationship::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'nok_postal_address'); ?>
		<?php echo $form->textField($model, 'nok_postal_address', array('maxlength' => 200)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'nok_postcode'); ?>
		<?php echo $form->textField($model, 'nok_postcode', array('maxlength' => 10)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'nok_town'); ?>
		<?php echo $form->textField($model, 'nok_town', array('maxlength' => 20)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'nok_mobile'); ?>
		<?php echo $form->textField($model, 'nok_mobile', array('maxlength' => 20)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'nok_email'); ?>
		<?php echo $form->textField($model, 'nok_email', array('maxlength' => 40)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model, 'employer_email', array('maxlength' => 30)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model, 'expected_completion_date', array('maxlength' => 30)); ?>
	</div>
