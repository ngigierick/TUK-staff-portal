...
abstract class BaseStudent extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('photo', 
					...
					'on'=>'update', 
					'on'=>'insert', 
					'message'=>'Save passport photo as .JPG and should not exceed 200px by 200px',
					'maxSize'=>1024 * 1024 * 1, 'tooLarge'=>'Passport photo has to be smaller than 1MB',
	...
	public function attributeLabels() {
		return array(
			...
			'county' => null,
			'district' => null,
			'disability' => 'Having form of disability?',
			'ethnicity' => null,
			'gender' => null,
			'maritalStatus' => null,
			'nationality' => null,
	...
	public function search() {
		...
		$criteria->compare('LOWER(class_code)', strtolower($this->class_code), true);
		...
		$criteria->compare('LOWER(othername)', strtolower($this->othername), true);
