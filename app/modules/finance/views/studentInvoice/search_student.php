...
<h1>Search Student and Semester for Invoicing</h1>
...
<?php
		...
		$this->widget('zii.widgets.jui.CJuiAutoComplete', array(
			...
			'id'=>'prog_code',
			'source'=>$this->createUrl('/admission/student/showStudents'),
			'options'=>array(
				'delay'=>300,
				'minLength'=>2,
				'showAnim'=>'fold',
...
?>
<?php //echo $form->textField($model, 'reg_number', array('maxlength' => 30,'id'=>'programmecode')); ?>
