...
<h2><?php echo GxHtml::encode($model->getRelationLabel('feepayables')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->feepayables as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('feepayable/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
