...
class EmployeePublicationController extends GxController {
...
public $pageTitle = ":: Staff ePortal";
	...
	public function actionView($id) {
		if (!Yii::app()->getRequest()->getIsAjaxRequest())
			$this->render('view', array(
				'model' => $this->loadModel($id, 'EmployeePublication'),
			));
		else
	...
	public function actionCreate() {
		...
		$model = new EmployeePublication;


		if (isset($_POST['EmployeePublication'])) {
			$model->setAttributes($_POST['EmployeePublication']);
	...
	public function actionDelete1($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'EmployeePublication')->delete();
	...
	public function actionDelete($id) {
		...
		if ($this->loadModel($id, 'EmployeePublication')->delete()){
	...
	public function actionIndex() {
		$model = new EmployeePublication('search');
		$model->unsetAttributes();

		if (isset($_GET['EmployeePublication']))
			$model->setAttributes($_GET['EmployeePublication']);
