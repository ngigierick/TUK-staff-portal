...
class EmployeeCourseTaughtController extends GxController {
...
public $pageTitle = ":: Staff ePortal";
	...
	public function actionView($id) {
		if (!Yii::app()->getRequest()->getIsAjaxRequest())
			$this->render('view', array(
				'model' => $this->loadModel($id, 'EmployeeCourseTaught'),
			));
		else
	...
	public function actionCreate() {
		...
		$model = new EmployeeCourseTaught;


		if (isset($_POST['EmployeeCourseTaught'])) {
			$model->setAttributes($_POST['EmployeeCourseTaught']);
			...
			//$model->home=$model->country;
				...
				if ($model->save()) {
					...
					$activity->user_cat =4;
					$activity->details = "staff added course taught details ";
					$activity->date_recorded = time();
					$activity->save();
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['EmployeeCourseTaught'])) {
			...
			if ($model->save()) {
				...
				$activity->theuser = $staff->id;
				$activity->user_cat =4;
				$activity->details = "staff updated course taught details ";
				$activity->date_recorded = time();
				$activity->save();
	...
	public function actionDelete1($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'EmployeeCourseTaught')->delete();
	...
	public function actionDelete($id) {
		...
		if ($this->loadModel($id, 'EmployeeCourseTaught')->delete()){
	...
	public function actionIndex() {
		$model = new EmployeeCourseTaught('search');
		$model->unsetAttributes();

		if (isset($_GET['EmployeeCourseTaught']))
			$model->setAttributes($_GET['EmployeeCourseTaught']);
