...
array(
			'name' => 'level',
			'type' => 'raw',
			'value' => $model->level !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->level)), array('programmetype/view', 'id' => GxActiveRecord::extractPkValue($model->level, true))) : null,
			),
'name',
'institution',
'year',
