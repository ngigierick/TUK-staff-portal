...
array(
			'name' => 'bank',
			'type' => 'raw',
			'value' => $model->bank !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->bank)), array('bankaccount/view', 'id' => GxActiveRecord::extractPkValue($model->bank, true))) : null,
			),
'account_number',
'branch',
'status:boolean',
