...
/**
 * This is the model base class for the table "{{previousstudentcredit}}".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "PreviousStudentCredit".
 *
 * Columns in table "{{previousstudentcredit}}" available as properties of the model,
 ...
 *
 */
abstract class BasePreviousStudentCredit extends GxActiveRecord {
	...
	public function tableName() {
		return '{{previousstudentcredit}}';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'PreviousStudentCredit|PreviousStudentCredits', $n);
	}
	...
	public function rules() {
		return array(
			...
			array('type_, course_yr, reg_fee, caution, union_, sports, maint, medical, tuition, misc, cse_tot, exam, hostel, total, val', 'length', 'max'=>10),
