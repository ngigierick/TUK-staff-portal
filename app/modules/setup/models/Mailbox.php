...
class Mailbox extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('category_id, from_id, to_id, subject, body, status_id, date_modified', 'required'),
			array('category_id, from_id, to_id, status_id', 'numerical', 'integerOnly'=>true),
			array('subject, date_modified', 'length', 'max'=>30),
	...
	{
		$this->status_id = ($this->status_id===0)?'<div class="unread">Unread</div>':'<div class="read">Read</div>';
	}
}