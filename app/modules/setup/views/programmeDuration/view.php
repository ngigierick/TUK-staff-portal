...
<h2><?php echo GxHtml::encode($model->getRelationLabel('programmes')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->programmes as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('programme/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
