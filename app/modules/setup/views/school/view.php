...
array(
			'name' => 'faculty',
			'type' => 'raw',
			'value' => $model->faculty !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->faculty)), array('faculty/view', 'id' => GxActiveRecord::extractPkValue($model->faculty, true))) : null,
			),
'notes',
'date_modified',
'status_id',
