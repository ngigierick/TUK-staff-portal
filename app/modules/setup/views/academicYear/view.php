...
<h2><?php echo GxHtml::encode($model->getRelationLabel('applicationfees')); ?></h2>
<?php
	echo GxHtml::openTag('ol');
	foreach($model->applicationfees as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('/intake/applicationfees/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
		echo GxHtml::closeTag('li');
	}
	echo GxHtml::closeTag('ol');
?><h2><?php echo GxHtml::encode($model->getRelationLabel('semesters')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->semesters as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('semester/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
		echo GxHtml::closeTag('li');
	}
