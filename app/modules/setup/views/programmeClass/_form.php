...
<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->dropDownList($model, 'programme_id', GxHtml::listDataEx(Programme::model()->findAllAttributes(null, true))); ?>
		<?php echo $form->error($model,'programme_id'); ?>
		</div><!-- row -->
		<div class="row">
