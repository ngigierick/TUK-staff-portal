...
<h2><?php echo GxHtml::encode($model->getRelationLabel('programmeclasses')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->programmeclasses as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('programmeclass/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
